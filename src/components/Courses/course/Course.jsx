...
const Course = ({course,addToCart}) => {
      ...
      return (
            ...
            <div className="card-body bg-white  pt-3 pb-4 px-5 rounded-lg text-left">
              ...
              <div className="pt-2 ">
                <button onClick={()=>addToCart(course)} className="w-full p-1 active:scale-90 button-active hover:bg-[#39c6db] text-[19px]  rounded-lg bg-[#05BFDB] text-white">Select</button>
              </div>
            </div>
          </div>
      );
